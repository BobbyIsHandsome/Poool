...
public class TableConfig implements Configurable {
    ...
    private PocketsConfig pocketConfig;
    /**
     ...
     */
    public TableConfig(String colour, double friction, SizeConfig sizeConf, PocketsConfig pocketsConfig) {
        this.init(colour, friction, sizeConf, pocketsConfig);
    }

    private void init(String colour, double friction, SizeConfig sizeConf, PocketsConfig pocketsConfig) {
        ...
        this.size = sizeConf;
        this.pocketConfig = pocketsConfig;
    }
